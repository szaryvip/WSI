...
# – wystarczy użyć algorytmu DFS do sprawdzenia czy
...
# Można wygenerować jakąkolwiek planszę i sprawdzić DFS
# jej poprawność, ale jeżeli plansza jest niepoprawna
# to lepiej wygenerować kolejny przykład niż rzucać wyjątek
# i kończyć działanie. 
# - co do wartości startu i początku najlepiej jest je
# przekazać jako parametry waszego rozwiązania a nie
# opierać wszystkiego na losowym ziarnie.  
...
# - mają Państwo dowolność w interpretacji, co jak
# samochód wyjedzie poza obszar planszy (można zabronić
# a można potraktować jako dziury na obrysie) 
